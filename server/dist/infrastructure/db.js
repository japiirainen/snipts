...
var createDbPool = function () { return __awaiter(void 0, void 0, void 0, function () {
    var pool, client, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.trys.push([3, , 5, 7]);
                return [4 /*yield*/, postgres_migrations_1.migrate({ client: client }, 'sql')];
            case 4:
                _a.sent();
                return [3 /*break*/, 7];
            ...
            case 9: return [2 /*return*/, pool];
        }
    });
}); };
exports.createDbPool = createDbPool;
var witConn = function (pool, f) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, f(client)];
                case 3: return [2 /*return*/, _a.sent()];
                case 4:
                    e_2 = _a.sent();
                    throw new DBError(e_2.message);
                case 5: return [4 /*yield*/, client.release()];
                case 6:
                    _a.sent();
                    return [7 /*endfinally*/];
    ...
    }); }, function () { return new DBError('db error'); });
};
exports.witConn = witConn;
